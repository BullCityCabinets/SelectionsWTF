...
// adb pull /data/user/0/com.TomG.lgrm/files/.local/share/MyDatabase.db3 C:\Users\ScumS\Desktop
...
namespace LGRM.Data
{
    public partial class SQLiteConnector
    {
        ...
        public List<Recipe> GetAllRecipeMetas()
        {
            ...
            {
                CreateTableRecipesMetaAsync();
            }
            
            var id = 1; // Ensure there is at least 1 row, otherwise get an exception...
            var query = Db.Table<Recipe>().Where(i => i.Id == id);
            ...
            Console.WriteLine("~~~ recipeMetaList.Count()... " + recipeMetaList.Count() );
            return recipeMetaList;
        ...
        {
            //if (!Db.TableMappings.Any(m => m.MappedType.Name == typeof(Recipe).Name)) // This is an "Initial Run"
            //{
            //    try
            //    {
            //        await CreateTableRecipesMetaAsync();
            ...
            //    }
            //}
            recipe.Id = GetAllRecipeMetas().Count + 1;
